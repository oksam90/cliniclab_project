...
<div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">{{__('Request a appointment')}}</h3>
    </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control datepicker" id="appointment_date" placeholder="{{__('Appointment Date')}}" name="appointment_date" required readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card card-danger">
                                ...
                                <input type="hidden" name="lat" id="appointment_lat">
                                <input type="hidden" name="lng" id="appointment_lng">
...
@section('scripts')
    ...
    <script src="{{url('js/patient/appointment.js')}}"></script>
@endsection