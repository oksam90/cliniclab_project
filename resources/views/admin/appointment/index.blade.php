      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="#">{{__('appointment')}}</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="card card-primary card-outline">
    <div class="card-header">
      ...
      @can('create_appointment')
        <a href="{{route('admin.appointment.create')}}" class="btn btn-primary btn-sm float-right">
    ...
    <div class="card-body">
        ...
        <div class="col-lg-12 table-responsive">
            <table id="appointment_table" class="table table-striped table-hover table-bordered"  width="100%">
              <thead>
                <tr>
                  <th width="10px">#</th>
