        ...
        <div class="form-group">
            <div class="form-group">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control datepicker" id="appointment_date" placeholder="{{__('Appointment Date')}}" name="appointment_date" required @if(isset($appointment)) value="{{$appointment['appointment_date']}}" @endif style="z-index: 1000!important" readonly>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="form-group">
                    <label for="exampleInputFile">
                        ...
                        @if(!empty($appointment)&&!empty($appointment['attach']))
                            <a href="{{url('uploads/appointment/'.$appointment['attach'])}}" class="btn btn-primary btn-sm">
                                <i class="fa fa-eye"></i>
                            </a>
                        @endif
                    </label>
