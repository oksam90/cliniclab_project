...
Route::group(['prefix'=>'admin','as'=>'admin.','namespace'=>'Admin','middleware'=>'Admin'],function(){
    ...
    Route::get('appointment/create_tests/{id}','AppointmentController@create_tests')->name('appointment.create_tests');
    Route::get('get_appointment','AppointmentController@ajax')->name('get_appointment');
