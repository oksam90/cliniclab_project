...
Route::group(['prefix'=>'ajax','as'=>'ajax.'],function(){
    ...
    Route::post('change_appointment_status/{id}','AjaxController@change_appointment_status')->name('change_appointment_status')->middleware('Admin');
    ...
    Route::get('get_new_appointment','AjaxController@get_new_appointment')->name('get_new_appointment')->middleware('Admin');
